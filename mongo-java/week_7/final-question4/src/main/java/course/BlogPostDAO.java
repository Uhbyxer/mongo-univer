...
public class BlogPostDAO {
    ...
    public void likePost(final String permalink, final int ordinal) {
        ...
        //postsCollection.updateOne(post, new BasicDBObject("$inc", new BasicDBObject("comments." + ordinal + ".num_likes", 1)));


        UpdateResult result = postsCollection.updateOne(new BasicDBObject("permalink", permalink),
